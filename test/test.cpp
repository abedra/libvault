...
public:
  ...
  [[nodiscard]] std::optional<Vault::HttpResponse> post(const Vault::Url& url, const Vault::Token& token, const Vault::Namespace& ns, const std::string& value) const override {
    return response_;
  }
