...
std::optional<std::string> Vault::AliCloud::Auth::createRole(const Path &path, const Parameters &parameters) {
...
std::optional<std::string> Vault::AliCloud::Auth::login(const Parameters &parameters) {
