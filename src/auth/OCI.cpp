...
std::optional<std::string> Vault::OCI::createRole(const Path &path, const Parameters &parameters) {
...
std::optional<std::string> Vault::OCI::login(const Path &path, const Parameters &parameters) {
