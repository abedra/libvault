...
std::optional<std::string> Vault::Pki::generateRoot(const RootCertificateType &rootCertificateType, const Parameters &parameters) const {
...
std::optional<std::string> Vault::Pki::createRole(const Path &path, const Parameters &parameters) const {
  return HttpConsumer::post(client_,getUrl(Path{"roles/" + path}), parameters);
}

std::optional<std::string> Vault::Pki::updateRole(const Path &path, const Parameters &parameters) const {
  return HttpConsumer::post(client_,getUrl(Path{"roles/" + path}), parameters);
}
...
std::optional<std::string> Vault::Pki::issue(const Path &path, const Parameters &parameters) const {
...
std::optional<std::string> Vault::Pki::configureCA(const Parameters &parameters) const {
...
std::optional<std::string> Vault::Pki::setCrlConfiguration(const Parameters &parameters) const {
...
std::optional<std::string> Vault::Pki::generateIntermediate(const KeyType &keyType, const Parameters &parameters) const {
  return HttpConsumer::post(client_, getUrl(Path{"intermediate/generate/" + keyType}), parameters);
}

std::optional<std::string> Vault::Pki::signIntermediate(const Parameters &parameters) const {
  return HttpConsumer::post(client_, getUrl(Path{"root/sign-intermediate"}), parameters);
}

std::optional<std::string> Vault::Pki::setSignedIntermediate(const Parameters &parameters) const {
  return HttpConsumer::post(client_, getUrl(Path{"intermediate/set-signed"}), parameters);
}

std::optional<std::string> Vault::Pki::signSelfIssued(const Parameters &parameters) const {
  return HttpConsumer::post(client_, getUrl(Path{"root/sign-self-issued"}), parameters);
}

std::optional<std::string> Vault::Pki::generateCertificate(const Path &path, const Parameters &parameters) const {
  return HttpConsumer::post(client_, getUrl(Path{"issue/" + path}), parameters);
}

std::optional<std::string> Vault::Pki::sign(const Path &path, const Parameters &parameters) const {
  return HttpConsumer::post(client_, getUrl(Path{"sign/" + path}), parameters);
}

std::optional<std::string> Vault::Pki::signVerbatim(const Path &path, const Parameters &parameters) const {
...
std::optional<std::string> Vault::Pki::tidy(const Parameters &parameters) const {
  return HttpConsumer::post(client_, getUrl(Path{"tidy"}), parameters);
}

std::optional<std::string> Vault::Pki::revokeCertificate(const Parameters &parameters) const {
