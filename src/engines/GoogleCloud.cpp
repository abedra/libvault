...
std::optional<std::string> Vault::GoogleCloud::Secrets::configure(const Parameters &parameters) {
...
std::optional<std::string> Vault::GoogleCloud::Secrets::createRoleset(const Path &path, const Parameters &parameters) {
  return HttpConsumer::post(client_, getUrl(Path{"roleset/" + path}), parameters);
}

std::optional<std::string> Vault::GoogleCloud::Secrets::updateRoleset(const Path &path, const Parameters &parameters) {
  return HttpConsumer::post(client_, getUrl(Path{"roleset/" + path}), parameters);
}

std::optional<std::string> Vault::GoogleCloud::Secrets::rotateRolesetAccount(const Path &path) {
  return HttpConsumer::post(client_, getUrl(Path{"roleset/" + path + "/rotate"}), Parameters{});
}

std::optional<std::string> Vault::GoogleCloud::Secrets::rotateRolesetAccountKey(const Path &path) {
  return HttpConsumer::post(client_, getUrl(Path{"roleset/" + path + "/rotate-key"}), Parameters{});
}

std::optional<std::string> Vault::GoogleCloud::Secrets::readRoleset(const Path &path) {
...
std::optional<std::string> Vault::GoogleCloud::Secrets::deleteRoleset(const Path &path) {
  return HttpConsumer::del(client_, getUrl(Path{"roleset/" + path}));
}

std::optional<std::string> Vault::GoogleCloud::Secrets::generateSecretToken(const Path &path) {
  return HttpConsumer::get(client_, getUrl(Path{"token/" + path}));
}

std::optional<std::string> Vault::GoogleCloud::Secrets::generateSecretKey(const Path &path) {
