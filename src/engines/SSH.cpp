...
std::optional<std::string> Vault::SSH::createKey(const Path &path, const Parameters &parameters) {
  return HttpConsumer::post(client_, getUrl(Path{"keys/" + path}), parameters);
}

std::optional<std::string> Vault::SSH::updateKey(const Path &path, const Parameters &parameters) {
  return HttpConsumer::post(client_, getUrl(Path{"keys/" + path}), parameters);
}
...
std::optional<std::string> Vault::SSH::createRole(const Path &path, const Parameters &parameters) {
...
std::optional<std::string> Vault::SSH::configureZeroAddressRoles(const Parameters &parameters) {
  return HttpConsumer::post(client_, getUrl(Path{"config/zeroaddress"}), parameters);
}
...
std::optional<std::string> Vault::SSH::generateCredentials(const Path &path, const Parameters &parameters) {
  return HttpConsumer::post(client_, getUrl(Path{"creds/" + path}), parameters);
}

std::optional<std::string> Vault::SSH::listRolesByIp(const Parameters &parameters) {
...
std::optional<std::string> Vault::SSH::configureCA(const Parameters &parameters) {
...
std::optional<std::string> Vault::SSH::signKey(const Path &path, const Parameters &parameters) {
